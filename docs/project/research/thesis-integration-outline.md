...
- Use screenshots only after the Task 12 capture gate records current raster
  evidence; until then, source-backed SVG/test evidence is the valid artifact.
