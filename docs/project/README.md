...
- [Thesis integration outline](research/thesis-integration-outline.md)
...
- [Metamodel coverage evaluation](evidence/metamodel-coverage.md)
- [Correspondence coverage evaluation](evidence/correspondence-coverage.md)
- [Diagram performance evidence](evidence/diagram-performance.md)
- [Traceability diagram](evidence/traceability-diagram.mmd)
- [Thesis integration validation](evidence/thesis-integration-validation.md)
