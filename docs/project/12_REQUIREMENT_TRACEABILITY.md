...
| FR-DIA-008 | no implementation claimed | Planned export/demo/mutant/screenshot/performance evidence task sequence | architecture, product requirements, checklist |
