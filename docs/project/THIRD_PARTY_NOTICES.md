...
The plugin POM pins Jason `3.3.0` and the verified runtime dependency tree is:
...
jar tf .\use-bdi-plugin\target\use-bdi-plugin-7.1.1.jar |
  Select-String 'META-INF/THIRD-PARTY-NOTICES.txt|jason/asSemantics/Agent.class'
