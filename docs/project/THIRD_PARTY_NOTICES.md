...
The plugin POM pins JaCaMo `1.3.0`, CArtAgO `3.1`, Moise `1.1`, and Jason
`3.3.0`. JaCaMo
is used for its official static `.jcm` parser/model and CArtAgO for static
artifact API inspection. Moise parses static organization specifications behind
one adapter; all dependency transitives are excluded. The verified
...
| Moise organization parser/model 1.1 | `org.jacamo:moise:1.1` | GNU LGPLv3 | [github.com/moise-lang/moise](https://github.com/moise-lang/moise) |
...
jar tf .\use-bdi-plugin\target\use-bdi-plugin-7.1.1.jar |
  Select-String 'META-INF/THIRD-PARTY-NOTICES.txt|jacamo/project/parser/JaCaMoProjectParser.class|cartago/OPERATION.class|moise/os/OS.class|jason/asSemantics/Agent.class'
...
- The CArtAgO and Moise JARs are packaged for their static APIs. The plugin
  neither creates a workspace nor invokes `CartagoService`, organization
  enactment, or any JaCaMo runtime lifecycle.
