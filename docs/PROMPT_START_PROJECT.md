...
1. Đọc toàn bộ file AGENT.md.
2. Đọc README.md, 00_PROJECT_CONTEXT.md, 04_SYSTEM_ARCHITECTURE.md, 10_PLUGIN_TECHNICAL_DESIGN.md, 14_ROADMAP_TO_DECEMBER_2026.md và 16_PROJECT_COMPLETION_CHECKLIST.md.
...
5. Ghi các phát hiện có bằng chứng vào DECISION_LOG.md. Không đoán API.
...
7. Viết test hoặc smoke script phù hợp, cập nhật 16_PROJECT_COMPLETION_CHECKLIST.md.
...
```text
Đọc AGENT.md và tiếp tục task chưa hoàn thành có ưu tiên cao nhất trong 16_PROJECT_COMPLETION_CHECKLIST.md. Tuân thủ các ADR, triển khai một vertical slice nhỏ, có test, cập nhật tài liệu/checklist và commit khi test pass.
```
