...
public final class FilmstripModelConstants {
	...
	public static final String SUCC_OPC_EXISTS = "(not self. " + SUCC_ROLENAME + ".oclIsUndefined() implies (not self."
			+ OPC_ROLENAME + ".oclIsUndefined()))";
	/////////////
	...
	public static final String OPC_INV_ASSOCCLASSBEHAVIOR = "self." + PRED_ROLENAME + "->size() = 1 and "
	...
	public static final String SNAPSHOT_INV_ONEFILMSTRIP = "(" + SNAPSHOT_CLASSNAME + ".allInstances()->select( s | s."
	...
	// hanhdd-begin =======================
	public static String makeValidLinkingInvPart(String endName, String sourceClsName, String targetClsName,
